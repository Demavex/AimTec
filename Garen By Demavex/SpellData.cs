...
namespace Garen_By_Demavex
{
    ...
    public class SpellData
    {
        ...
        public SpellSlot spellKey { get; set; }
        ...
        static SpellData()
        {
            ...
            object CollisionObjectType = null;
            Spells.Add(
                new SpellData
                {
                    charName = "Ahri",
            ...
            Spells.Add(
                new SpellData
                {
                    ...
                    spellType = SpellType.Line,
                    // = new[] { CollisionObjectType.EnemyChampions, CollisionObjectType.EnemyMinions },
            ...
            Spells.Add(
                new SpellData
                {
                    ...
                    spellType = SpellType.Line,
                    //// = new[] { CollisionObjectType.EnemyChampions },
                });
            ...
            //    spellType = SpellType.Circular,
            //    // = "cassiopeia_base_w_wcircle_tar_" + Situation.EmitterTeam() + ".troy",
            //    //// = false,
            //    // = true
            //});
            ...
            Spells.Add(
                new SpellData
                {
                    ...
                    // = new[] { "ezrealmysticshotwrapper", },
                    // = new[] { "EzrealMysticShotPulseMissile" },
                    spellType = SpellType.Line,
                    // = new[] { CollisionObjectType.EnemyChampions, CollisionObjectType.EnemyMinions }
                });
            ...
            Spells.Add(
                new SpellData
                {
                    ...
                    // = new[] { "GnarQMissileReturn" }, // todo: special spell
            ...
            Spells.Add(
                new SpellData
                {
                    ...
                    spellType = SpellType.Circular,
                    // = 45,
                    // = "gragas_base_q_" + Situation.EmitterTeam() + ".troy",
                    // = true
                });
            ...
            Spells.Add(
                new SpellData
                {
                    ...
                    // = new[] { "GravesChargeShotFxMissile2" },
                    spellType = SpellType.Line,
                    // = true
                });
            ...
            Spells.Add(
                new SpellData
                {
                    ...
                    spellName = "IvernQ",
                    spellType = SpellType.Line,
                    // = new[] { CollisionObjectType.EnemyMinions, CollisionObjectType.EnemyChampions },
                });
            ...
            Spells.Add(
                new SpellData
                {
                    ...
                    spellType = SpellType.Circular,
                    // = new[] { "karthuslaywastea2", "karthuslaywastea3", "karthuslaywastedeada1", "karthuslaywastedeada2", "karthuslaywastedeada3" }
                });
            ...
            Spells.Add(
                new SpellData
                {
                    ...
                    spellName = "LuxLightStrikeKugel",
                    spellType = SpellType.Circular,
                    // = "lux_base_e_tar_aoe_" + Situation.EmitterColor() + ".troy",
                    // = -100,
                    // = true
                });
            ...
            Spells.Add(
                new SpellData
                {
                    ...
                    spellType = SpellType.Circular,
                    // = "morgana_base_w_tar_" + Situation.EmitterColor() + ".troy",
                    // = true
                });
            ...
            Spells.Add(
                new SpellData
                {
                    ...
                    spellName = "Bushwhack",
                    spellType = SpellType.Circular,
                    // = "nidalee_base_w_tc_" + Situation.EmitterColor() + ".troy",
                    // = true
                });
            ...
            Spells.Add(
                new SpellData
                {
                    ...
                    spellKey = SpellSlot.R,
                    spellName = "SionR",
                    spellType = SpellType.SkillshotUnknown, // temp removal
                    // = new[] { CollisionObjectType.EnemyChampions },
                    // = true
                });
            ...
            Spells.Add(
                new SpellData
                {
                    ...
                    spellKey = SpellSlot.Q,
                    spellType = SpellType.Circular,
                    // = "zilean_base_q_timebombground" + Situation.EmitterColor() + ".troy",
                    // = -100,
                    // = true
                });
